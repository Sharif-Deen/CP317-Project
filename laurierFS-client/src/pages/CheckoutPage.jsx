...
export default function CheckoutPage() {
  ...
  const validateShipping = () => {
    ...
    if (!/^[A-Z]\d[A-Z] \d[A-Z]\d$/.test(shipping.postalCode.toUpperCase()))
    ...
    <div className="checkout-page">
      ...
      <div className="checkout-navbar">
        ...
        <div className="nav-links">
          ...
          <a href="/search">Search</a>
          <a href="/cart">Cart</a>
          <a href="/checkout" className="active">Checkout</a>
        </div>
      </div>
              ...
              <div className="checkout-card">
                ...
                <div className="form-row">
                  ...
                  <div className="form-group">
                    ...
                    <input type="text" placeholder="N2L 3C5"
                ...
                <div className="form-group">
                  ...
                  <input type="text" placeholder="519-123-4567"
                    value={shipping.phone}
                    onChange={e => setShipping({...shipping, phone: e.target.value})} />
                  {errors.phone && <p className="error">{errors.phone}</p>}
                </div>

                <button className="checkout-btn" onClick={handleShippingNext}>
                  Continue to Payment →
                </button>
              </div>
            )}
            ...
            {step === 2 && (
              <div className="checkout-card">
                ...
                <div className="payment-toggle">
                  <button
                    className={`toggle-btn ${payment.method === "credit" ? "selected" : ""}`}
                    onClick={() => setPayment({...payment, method: "credit"})}>
                    💳 Credit Card
                  </button>
                  <button
                    className={`toggle-btn ${payment.method === "debit" ? "selected" : ""}`}
                    onClick={() => setPayment({...payment, method: "debit"})}>
                    🏦 Debit Card
                  </button>
                </div>
